...
var Manager = /** @class */ (function (_super) {
    ...
    function Manager(name, age) {
        ...
        _this.tasks.push(" is perparing a quarterly meeting..");
        return _this;
    }
...
var junior = new Junior('Maria', 21);
junior.salary = 1000;
junior.collectSalary();
junior.work();
var senior = new Senior('Pesho', 30);
senior.salary = 4500;
senior.collectSalary();
senior.work();
senior.work();
senior.work();
var manager = new Manager('Pesho The Tiger', 35);
